...
export default function Signup() {
    ...
    React.useEffect(() => {
        ...
        async function getCity() {
            try {
                const response = await axios.get('http://localhost:8081/api/city/list-city');
                console.log(response);
            ...
            axios.get('http://localhost:8081/api/service/list-Service')
                .then(r => {
                    console.log(r);
                    setServices(r.data);
                    console.log("ccccc", citys);
    ...
    console.log("ffffffffffffffffffffff", formData)
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <FormControl fullWidth>
                                        ...
                                        >
                                            {citys.map(items =>
                                                <MenuItem key={items.id} value={items.id}>{items.label}</MenuItem>
                                            )}
                                ...
                                <Grid item xs={12}>
                                    <FormControl fullWidth>
                                        ...
                                        >
                                            {services.map(items =>
                                                <MenuItem key={items.id} value={items.id}>{items.nom}</MenuItem>
                                            )}
